...
class FinanceAgent extends SubAgent {
  ...
  static const String _systemPrompt =
    ...
    "2. After executing the tool, write a brief, friendly, one-sentence summary of the action for the shopkeeper (e.g., 'I have successfully generated your business analytics report.'). Do NOT output raw JSON in your text response.\n"
    "3. If parameters are missing, say exactly what is missing.\n"
    "4. NEVER generate greetings, apologies, narrative, or suggestions.\n"
    "5. NEVER hallucinate financial numbers. If a tool returns empty results, state that clearly.\n"
