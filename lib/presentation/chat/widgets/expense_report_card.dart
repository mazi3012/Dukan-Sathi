...
class ExpenseReportCard extends StatelessWidget {
  ...
  const ExpenseReportCard({super.key, required this.payload});

  @override
  Widget build(BuildContext context) {
    final double total = (payload['total'] as num?)?.toDouble() ?? 0.0;
    final String? filterCategory = payload['category'] as String?;
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        filterCategory != null
                            ? '${filterCategory.toUpperCase()} EXPENSE REPORT'
                            : 'EXPENSE REPORT',
                        style: TextStyle(
                          fontSize: 11.0,
                      ...
                      Text(
                        'Total Outflow: ₹${total.toStringAsFixed(2)}',
            ...
            if (expenses.isEmpty)
              ...
              ListView.separated(
                ...
                itemBuilder: (context, index) {
                  final expense = Map<String, dynamic>.from(expenses[index] as Map);
                  final desc = expense['description'] as String? ?? 'General Expense';
