...
String getGenkitUI() => r'''<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <script>
                ...
                if (response.ok) {
                    ...
                    resultBox.innerHTML = `
                        <div class="result-box">
                            ...
                            ${result}<br/><br/>
                            <strong>Trace ID:</strong> ${telemetry.traceId || 'N/A'}<br/>
                            <strong>Status:</strong> <span class="status-success">✓ Success</span><br/>
                    ...
                    resultBox.innerHTML = `<div class="result-box"><span class="status-running">Error: ${data.error}</span></div>`;
                }
            } catch (error) {
                resultBox.innerHTML = `<div class="result-box"><span class="status-running">Error: ${error.message}</span></div>`;
            }
        ...
        function addTrace(name, type, status, tokens, duration) {
            ...
            row.innerHTML = `
                <td>${name}</td>
                <td><span class="tool-badge">${type}</span></td>
